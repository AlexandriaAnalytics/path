...
CREATE TABLE `countries` (
  ...
  `monetary_unit` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `monetary_unit_symbol` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `institute_custom_level_price` (
  ...
  `percentage_extra_price_all_modules` decimal(12,2) DEFAULT NULL COMMENT 'Extra price for all modules',
  `percentage_extra_price_exam_right` decimal(12,2) DEFAULT NULL COMMENT 'Extra price for exam right',
  `percentage_extra_price_exam_right_all_modules` decimal(12,2) DEFAULT NULL COMMENT 'Extra price for exam right for all modules',
  `extra_price_all_modules` decimal(12,2) DEFAULT NULL COMMENT 'Extra price for all modules',
  `extra_price_exam_right` decimal(12,2) DEFAULT NULL COMMENT 'Extra price for exam right',
  `extra_price_exam_right_all_modules` decimal(12,2) DEFAULT NULL COMMENT 'Extra price for exam right for all modules',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `institute_payments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `institute_id` bigint unsigned NOT NULL,
  `ticket_link` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `institute_types` (
  ...
  `files_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `level_country_module` (
  ...
  `level_country_id` bigint unsigned NOT NULL,
  `module_id` bigint unsigned NOT NULL,
  `module_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Type of module',
...
CREATE TABLE `payments` (
  ...
  `status` enum('pending','approved','rejected','processing payment') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `suscription_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `instalment_number` int DEFAULT NULL,
  `current_instalment` int DEFAULT NULL,
  `candidate_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `students` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `institute_id` bigint unsigned NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Email address for login and notifications',
  `email_verified_at` timestamp NULL DEFAULT NULL,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remember_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'First name(s)',
  `surname` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Last name(s)',
  `birth_date` date NOT NULL COMMENT 'Date of birth',
  `cbu` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Clave Bancaria Uniforme (CBU)',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `personal_educational_needs` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2024_01_25_212226_create_exam_settings',1);
